...
import com.example.testwheel.CycleWheelView.CycleWheelViewException;
import com.example.testwheel.CycleWheelView.WheelItemSelectedListener;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cycleWheelView1.setWheelItemLayout(R.layout.item_cyclewheel_custom,
				R.id.tv_label_item_wheel_custom);
		cycleWheelView1
				.setOnWheelItemSelectedListener(new WheelItemSelectedListener() {
					@Override
					public void onItemSelected(int position, String label) {
